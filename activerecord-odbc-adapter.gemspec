Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if current_version >= 3 then
      ...
      #s.add_dependency(%q<activerecord>, [">= 2.3.0", "<3.0"])
    end
  else
    #s.add_dependency(%q<activerecord>, [">= 2.3.0", "<3.0"])
  end
